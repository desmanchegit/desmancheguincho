...
async function buildAll() {
  ...
  await esbuild({
    entryPoints: [
      ...
      path.resolve(artifactDir, "src/asaas-payment-service.ts"),
      path.resolve(artifactDir, "src/asaas-payment-links.ts"),
      path.resolve(artifactDir, "src/per-transaction-billing.ts"),
