      ...
      <DialogContent className="max-w-2xl max-h-[80vh] flex flex-col p-0 gap-0">
        <DialogHeader className="px-6 py-4 border-b shrink-0">
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            CENTRAL DOS DESMANCHES ATIVIDADES DE INTERNET LTDA – ME — CNPJ nº 45.450.395/0001-62
          </p>
        </DialogHeader>
        ...
        <div className="overflow-y-auto px-6 py-5 space-y-5 text-sm text-slate-600 leading-relaxed">
          ...
          <p>
            ...
            Termos de Uso. O uso de quaisquer serviços e ferramentas integradas significa que{" "}
            <strong>VOCÊ LEU, entendeu e consentiu</strong> com esta Política de Privacidade e com os
            Termos de Uso de cada serviço que você acessar ou usar. No uso de nossos serviços, o usuário
            deverá obedecer a legislação vigente, a moral, a ordem pública e os bons costumes.
          </p>
